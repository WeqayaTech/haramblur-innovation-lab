...
# NOTE: turban excluded — worn by both genders. ghutra_keffiyeh is specifically
# male Arab headwear and is a reliable contradiction signal.
WOMAN_CONTRADICTORS = {
    "facial_hair": {"moustache", "short_beard", "full_beard"},
    "head_covering": {"ghutra_keffiyeh"},
