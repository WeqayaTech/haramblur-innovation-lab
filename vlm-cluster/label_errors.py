#!/usr/bin/env python3
"""
confirmed LABEL ERRORS from the hard-negative descriptions.
...
# 'teenager' is deliberately treated as ambiguous (not confidently child/adult)
...
def classify(rec: dict):
    ...
    age = o.get("apparent_age_band", "unknown") 
