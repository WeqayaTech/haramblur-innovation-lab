...
![Gender confusion matrix](assets/gender_confusion_matrix.svg)
...
![What the VLM predicted per true age group](assets/prediction_by_gt_group.svg)
...
![Accuracy by true age](assets/age_accuracy_by_gt_age.svg)
...
![Age confusion matrix](assets/age_confusion_matrix.svg)
...
![Gender accuracy vs coverage by age](assets/gender_accuracy_by_age.svg)
...
![What the VLM called each true age](assets/age_detected_vs_actual.svg)
...
![Accuracy at each child cutoff](assets/child_threshold_sweep.svg)
